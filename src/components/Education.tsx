...
const positions = [
  {
    ...
    description:
      "Led 60+ members, organized 10+ technical events, and initiated coding practice groups and project development activities for the chapter.",
  },
  {
    title: "Executive Member",
    organization: "Career Service Advisory – XIM University",
    description:
      "Managed training and development activities for 60+ students and conducted coding practice sessions and placement preparation workshops.",
  },
];
      ...
      <div className="container-custom">
        ...
        <div className="flex items-center gap-4 mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-foreground whitespace-nowrap">
            <span className="text-primary font-mono text-xl">04.</span> Education & Experience
          </h2>
                  ...
                  >
                    <div
                      className={`w-2 h-2 rounded-full ${
                        edu.current ? "bg-primary animate-pulse" : "bg-muted-foreground"
                      }`}
                    />
                  </div>
              ...
              <div className="space-y-4">
                {certificates.map((cert, index) => (
                  <a
                    ...
                    className="block p-4 rounded-lg bg-card border border-border hover:border-primary/50 transition-all duration-300 group hover-lift"
                  >
