...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
      ...
      <div className="absolute bottom-1/3 right-1/4 w-[400px] h-[400px] bg-primary/3 rounded-full blur-[100px] animate-pulse-glow" style={{ animationDelay: "1s" }} />
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Title */}
          <h2 className="text-lg sm:text-xl md:text-2xl font-medium text-primary mb-8 animate-slide-up tracking-widest uppercase" style={{ animationDelay: "0.1s" }}>
            Software Development Engineer
          </h2>
          
          {/* Description */}
          <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto mb-8 leading-relaxed animate-slide-up font-light" style={{ animationDelay: "0.2s" }}>
          ...
          {/* Location */}
          <div className="flex items-center justify-center gap-2 text-muted-foreground mb-10 animate-slide-up" style={{ animationDelay: "0.3s" }}>
            <MapPin size={14} className="text-primary" />
            <span className="text-sm font-light tracking-wide">Ramgarh, Jharkhand, India</span>
          </div>
          
          {/* Social Links */}
          <div className="flex items-center justify-center gap-3 mb-12 animate-slide-up" style={{ animationDelay: "0.4s" }}>
            <a
              href="mailto:kaifkhurshid18@gmail.com"
              className="p-3.5 rounded-xl bg-card/80 border border-border/50 hover:border-primary/50 hover:text-primary hover:bg-card transition-all duration-300 hover-lift backdrop-blur-sm"
              aria-label="Email"
            >
              <Mail size={18} />
            </a>
          ...
          <div className="animate-slide-up" style={{ animationDelay: "0.5s" }}>
            <a
              href="#projects"
              className="inline-flex px-10 py-4 bg-primary text-primary-foreground font-semibold rounded-xl hover:bg-primary/90 transition-all duration-300 glow-effect hover-lift text-sm tracking-wide uppercase"
            >
              View My Projects
            </a>
          </div>
